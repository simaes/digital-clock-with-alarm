...
_0x4:
	...
	.DB  0x9
_0x5:
	.DB  0x21,0x53,0x45,0x54,0x0,0x0,0x0,0x0
	.DB  0x53,0x45,0x54
_0x0:
	.DB  0x25,0x69,0x3A,0x25,0x69,0x3A,0x25,0x69
	.DB  0x20,0x41,0x4C,0x4D,0x3A,0x25,0x73,0x0
	.DB  0x41,0x4C,0x41,0x52,0x4D,0x3A,0x20,0x25
...
; 0000 0080         inputcounter = ( inputcounter *10 ) + keys[pos];
	LDS  R30,_inputcounter
	LDS  R31,_inputcounter+1
	LDS  R22,_inputcounter+2
	LDS  R23,_inputcounter+3
	__GETD2N 0xA
	CALL __MULD12U
	PUSH R23
	PUSH R22
	...
	CALL __CWD1
	CALL __ADDD12
	STS  _inputcounter,R30
	STS  _inputcounter+1,R31
	STS  _inputcounter+2,R22
	STS  _inputcounter+3,R23
; 0000 0081         if(pos == 9){
	LD   R26,Y
	LDD  R27,Y+1
	SBIW R26,9
...
SUBOPT_0x0:
	LDS  R26,_inputcounter
	LDS  R27,_inputcounter+1
	LDS  R24,_inputcounter+2
	LDS  R25,_inputcounter+3
	__GETD1N 0xA
	CALL __DIVD21U
	STS  _key_value,R30
	STS  _key_value+1,R31
	STS  _key_value+2,R22
	STS  _key_value+3,R23
	LDI  R30,LOW(0)
	STS  _inputcounter,R30
	STS  _inputcounter+1,R30
	STS  _inputcounter+2,R30
	STS  _inputcounter+3,R30
	LDS  R26,_key_value
	LDS  R27,_key_value+1
	LDS  R24,_key_value+2
	LDS  R25,_key_value+3
	__GETD1N 0x64
	CALL __MODD21U
	RET
